<button type="button" class="tambah btn-sm btn-success mb-3" data-toggle="modal" data-target="#myModal"><i
		class="fas fa-plus"></i> Tambah Potongan</button>
				...
				<tbody>
					...
					foreach ($hasil as $item) {
						...
						<tr>
							...
							<td>Rp.
								<?php echo number_format($item->jml_potongan, 0, ',', '.') ?>
							</td>
							<td>
								<button type="button" potongan="<?php echo $item->potongan; ?>"
		...
		$('.tambah').click(function () {
			...
			$.ajax({
				...
				success: function (data) {
					...
					// Show the form inside the modal
					$('#tampil_modal').html(`
					<form method="post" id="form">
						...
						<button id="tombol_tambah" type="button" class="btn btn-primary">Tambah</button>
					</form>`);
