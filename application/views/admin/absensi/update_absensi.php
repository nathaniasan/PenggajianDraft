		...
		<table class="table table-bordered table-striped">
			...
			foreach ($kehadiran as $a): ?>
				<tr>
					...
					<td><input type="number" name="hadir[]" class="form-control" value="<?php echo $a->hadir ?>"></td>
					<td><input type="number" name="sakit[]" class="form-control" value="<?php echo $a->sakit ?>"></td>
					<td><input type="number" name="alpha[]" class="form-control" value="<?php echo $a->alpha ?>"></td>
				<?php endforeach; ?>
		</table><br></br><br></br>
	</form>
