		...
		<?php foreach ($jabatan as $j): ?>
			<form method="POST" action="<?php echo base_url('admin/data_jabatan/update_data_aksi') ?>">
				...
				<div class="form-group">
					...
					<input type="number" name="tj_struktural" class="form-control" value="<?php echo $j->tj_struktural ?>">
				...
				<div class="form-group">
					...
					<input type="number" name="insentif_mgmp" class="form-control" value="<?php echo $j->insentif_mgmp ?>">
				...
				<div class="form-group">
					...
					<input type="number" name="tunjangan_yayasan" class="form-control"
						value="<?php echo $j->tunjangan_yayasan ?>">
					<?php echo form_error('tunjangan_yayasan', '<div class="text-small text-danger"> </div>') ?>
				</div>
				<div class="form-group">
					<label>Tunjangan BPJS (staff)</label>
					<input type="number" name="tj_bpjs" class="form-control" value="<?php echo $j->tj_bpjs ?>">
