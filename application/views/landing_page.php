				...
				<div class="row Section">
					<div class="col">
						<div class="box">
							...
							<p>Selmat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>SMA YP Unila</p>
						</div>
					</div>
					<div class="col headerImg"
						style="background-image: url('<?php echo base_url() ?>assets/img/uangg.svg');">
					</div>
		...
		<div class="Section">
			<div class="text-center">
				...
				<div class="subHeading">
					Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan SMA YP Unila</div>
			</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-4 col-xl-3 ">
						<div class="card">
							...
							<div class="body">
								...
								<div id="panel1">aplikasi ini dibuat untuk membantu perusahaan dalam proses penggajian karyawan
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 ">
						<div class="card">
							...
							<div class="body">
								<div class="title">
									<font size="4"><b><i>Halaman Admin</font></b></i>
								</div>
								<div id="flip2">
									<font color="white">Baca Selengkapnya</font>
								</div>
								<div id="panel2">Administrator dapat menggunakan website untuk mengelola data pada website,
									halaman administrator terdapat dashboard / informasi singkat mengenai data data, terdapat
									data karyawan untuk pengelolaan karyawan, terdapat data jabatan untuk pengelolaan jabatan,
									terdapat data transaksi yang memiliki sub menu data absensi, setting potongan gaji, data
									gaji, terdapat data laporan yang memiliki sub menu laporan absensi, laporan gaji, cetak slip
									gaji.</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 ">
						<div class="card">
							...
							<div class="body">
								<div class="title">
									<font size="4"><b><i>Halaman Karyawan</font></b></i>
								</div>
								<div id="flip3">
									<font color="white">Baca Selengkapnya</font>
								</div>
								<div id="panel3">Halaman karyawan terdapat informasi tentangb karyawan dan cetak slip gaji.
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-4 col-xl-3 ">
						<div class="card">
							...
							<div class="body">
								<div class="title">
									<font size="4"><b><i>Fitur Lainnya</font></b></i>
								</div>
								<div id="flip4">
									<font color="white">Baca Selengkapnya</font>
								</div>
			...
			<div class="content">
				<div class="team row">
					<div class="team-memeber col-md-6 col-lg-4 col-xl-3">
						<div class="card">
							<div class="TopImg">
								<img src="<?php echo base_url(); ?>assets/img/logogaji.png"
									class="rounded-circle w-100 d-block">
							</div>
							<div class="TeamInfo text-center">
								<div class="Name">PENGGAJIAN GURU DAN STAFF</div>
								<div class="Job"><b>SMA YP Unila</b></div>
								<div class="social_links">
									<div class="social">
										<a class="" href="www.github.com"><i class="fab fa-github" aria-hidden="true"></i></a>
									</div>
									<div class="social">
										<a class="" href="www.instagram.com"><i class="fab fa-instagram"
		...
		<div class="container">
			<div class="row">
				<div class="col-12 text-center my-3">
					Copyright &copy; Kelompok PKL 2 Universitas Lampung | Penggajian 2023 - All Rights Reserved
				</div>
			</div>
		</div>
	</div>
